...
With run_analysis.R the data from a Smartphones Dataset will be adjusted.
...
Make sure that the datafile (https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip) is unzipped and will be in the working directory.



Original text from the dataset is the following:
